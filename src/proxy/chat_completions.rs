...
use super::types::{ChatCompletionRequest, ChatCompletionResponse, OpenAIError};
...
pub async fn chat_completions(
...
) -> Result<Json<ChatCompletionResponse>, (StatusCode, Json<OpenAIError>)> {
    ...
    // Force non-streaming for this handler
